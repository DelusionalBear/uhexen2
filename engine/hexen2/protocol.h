...
// Bits to help send server info about the client's extended inventory variables (all change stat bar)
#define SC3_CNT_ITEM1		(1<<0)
#define SC3_CNT_ITEM2		(1<<1)
#define SC3_CNT_ITEM3		(1<<2)
#define SC3_CNT_ITEM4		(1<<3)
#define SC3_CNT_ITEM5		(1<<4)
#define SC3_CNT_ITEM6		(1<<5)
#define SC3_CNT_ITEM7		(1<<6)
#define SC3_CNT_ITEM8		(1<<7)
#define SC3_CNT_ITEM9		(1<<8)
#define SC3_CNT_ITEM10		(1<<9)
#define SC3_CNT_ITEM11		(1<<10)
#define SC3_CNT_ITEM12		(1<<11)
#define SC3_CNT_ITEM13		(1<<12)
#define SC3_CNT_ITEM14		(1<<13)
#define SC3_CNT_ITEM15		(1<<14)
#define SC3_CNT_ITEM16		(1<<15)
#define SC3_CNT_ITEM17		(1<<16)
#define SC3_CNT_ITEM18		(1<<17)
#define SC3_CNT_ITEM19		(1<<18)
#define SC3_CNT_ITEM20		(1<<19)
#define SC3_CNT_ITEM21		(1<<20)
#define SC3_CNT_ITEM22		(1<<21)
#define SC3_CNT_ITEM23		(1<<22)
#define SC3_CNT_ITEM24		(1<<23)
#define SC3_CNT_ITEM25		(1<<24)
#define SC3_CNT_ITEM26		(1<<25)
#define SC3_CNT_ITEM27		(1<<26)
#define SC3_CNT_ITEM28		(1<<27)
#define SC3_CNT_ITEM29		(1<<28)
#define SC3_CNT_ITEM30		(1<<29)
#define SC3_CNT_ITEM31		(1<<30)
#define SC3_CNT_ITEM32		(1<<31)
